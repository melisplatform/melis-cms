...
const DICT: Record<PeLang, Record<string, string>> = {
  fr: {
    ...
    // ── EditionCanvas ──
    ecLoadingEditor: "Chargement de l'éditeur…",
    ecErrorPrefix: 'Erreur : ',
    ecSaving: 'Enregistrement…',
    ecPanelTitle: "Contenus des zones Drag'n'Drop",
    ecExpandPanel: 'Déployer le panneau structure',
    ecCollapsePanel: 'Réduire le panneau',
    ecClosePanel: 'Fermer',
    ecNoZones: 'Aucune zone drag-drop sur cette page.',
    ecZonesButton: 'Zones',
    ecOpenDrawer: "Zones drag'n'drop",
    ecZonePrefix: "Drag'n'drop Zone",
    ecSelectZone: 'Sélectionner',
    ecAddPlugin: 'Ajouter un plugin',
    ecLayoutTitle: 'Disposition (colonnes / lignes)',
    ecZoneLayoutHeader: 'DISPOSITION DE LA ZONE',
    ecDuplicateZone: 'Dupliquer cette zone (avec son contenu) juste en dessous',
    ecNewZone: 'Ajouter une nouvelle zone vide juste en dessous',
    ecRemoveZone: 'Supprimer cette zone (créée dynamiquement)',
    ecZoneMoreActions: 'Actions de la zone',
    ecDragZone: 'Glisser pour réordonner cette zone',
    ecDragZoneDisabled: 'Cette zone n\'a pas de double (créé par « Dupliquer ») avec qui être réordonnée : elle s\'affiche à un endroit fixe du modèle de page, indépendant de l\'ordre.',
    ecMoveZoneUp: 'Monter la zone',
    ecMoveZoneDown: 'Descendre la zone',
    ecZoneReorderBlocked: 'Ces deux zones s\'affichent à des endroits fixes différents du modèle de page : leur ordre ne peut pas être échangé.',
    ecEmptyCell: 'Cellule vide — choisissez une disposition ou ajoutez un bloc.',
    ecConfigurePlugin: 'Configurer le plugin',
    ecConfigurePluginNamed: 'Configurer ce plugin',
    ecResponsiveWidths: 'Largeurs responsive (desktop / tablette / mobile)',
    ecWidthDesktop: 'Largeur desktop %',
    ecWidthTablet: 'Largeur tablette %',
    ecWidthMobile: 'Largeur mobile %',
    ecRemoveFromZone: 'Retirer de la zone',
    ecDuplicateBlock: 'Dupliquer le mini-template',
    ecDuplicateBlockFailed: 'La duplication du bloc a échoué.',
    ecMoreActions: 'Actions du bloc',
    ecOpenInMelisAi: 'Ouvrir dans Melis AI',
    ecAiUnavailable: 'Melis AI n’est pas disponible sur cette page.',
    ecMoveBlockUp: 'Monter le bloc',
    ecMoveBlockDown: 'Descendre le bloc',
    ecMiniTemplate: 'Mini-template',
    ecPluginPrefix: 'Plugin',
    ecClose: 'Fermer',
    ecAllGroups: 'Tous les groupes',
    ecZoneWord: 'zone',
    ecSearchPlugin: 'Rechercher un plugin…',
    ecLoadingPlugins: 'Chargement des plugins…',
    ecNoPluginMatch: 'Aucun plugin ne correspond.',
    ecSelectPage: 'Sélectionner une page',
    ecRemovePluginTitle: 'Retirer ce plugin ?',
    ecRemovePluginBody1: 'sera retiré de la zone. Vous pourrez le rajouter, mais sa configuration sera perdue.',
    ecRemoveBtn: 'Retirer',
    ecRemoveZoneTitle: 'Supprimer cette zone ?',
    ecRemoveZoneBody1: 'et tout son contenu seront supprimés de la page. Cette action est irréversible.',
    ecPluginNotFound: 'Plugin introuvable dans le document — configuration impossible.',
    ecConfigFor: 'Config',

    // ── PluginFormKit ──
    pfFixFields: 'Veuillez corriger les champs',
    pfSaveFailed: 'Échec de l’enregistrement.',
    pfNetworkError: 'Erreur réseau',
    pfChoose: '— Choisir —',
    pfChooseTemplate: '— Choisir un template —',
    pfTemplateHint: 'Gabarit de rendu du plugin.',
    pfFormFields: 'Champs du formulaire',
    pfColField: 'Champ',
    pfColShow: 'Afficher',
    pfColRequired: 'Obligatoire',
    pfNoField: 'Aucun champ.',
    pfDragToReorder: 'Glisser pour réordonner',
    pfShowField: 'Afficher ce champ',
    pfMakeRequired: 'Rendre obligatoire',
  },
  en: {
    // ── common ──
    loading: 'Loading…',
    ...
    // ── EditionCanvas ──
    ecLoadingEditor: 'Loading editor…',
    ecErrorPrefix: 'Error: ',
    ecSaving: 'Saving…',
    ecPanelTitle: 'Drag & drop zone contents',
    ecExpandPanel: 'Expand structure panel',
    ecCollapsePanel: 'Collapse panel',
    ecClosePanel: 'Close',
    ecNoZones: 'No drag-drop zone on this page.',
    ecZonesButton: 'Zones',
    ecOpenDrawer: 'Drag & drop zones',
    ecZonePrefix: 'Drag & drop zone',
    ecSelectZone: 'Select',
    ecAddPlugin: 'Add a plugin',
    ecLayoutTitle: 'Layout (columns / rows)',
    ecZoneLayoutHeader: 'ZONE LAYOUT',
    ecDuplicateZone: 'Duplicate this zone (with its content) right below',
    ecNewZone: 'Add a new empty zone right below',
    ecRemoveZone: 'Remove this zone (dynamically created)',
    ecZoneMoreActions: 'Zone actions',
    ecDragZone: 'Drag to reorder this zone',
    ecDragZoneDisabled: 'This zone has no duplicate (made via "Duplicate") to reorder against — it shows at a fixed spot in the page template regardless of order.',
    ecMoveZoneUp: 'Move zone up',
    ecMoveZoneDown: 'Move zone down',
    ecZoneReorderBlocked: 'These two zones show at different fixed spots in the page template — their order can\'t be swapped.',
    ecEmptyCell: 'Empty cell — choose a layout or add a block.',
    ecConfigurePlugin: 'Configure plugin',
    ecConfigurePluginNamed: 'Configure this plugin',
    ecResponsiveWidths: 'Responsive widths (desktop / tablet / mobile)',
    ecWidthDesktop: 'Desktop width %',
    ecWidthTablet: 'Tablet width %',
    ecWidthMobile: 'Mobile width %',
    ecRemoveFromZone: 'Remove from zone',
    ecDuplicateBlock: 'Duplicate mini-template',
    ecDuplicateBlockFailed: 'Duplicating the block failed.',
    ecMoreActions: 'Block actions',
    ecOpenInMelisAi: 'Open in Melis AI',
    ecAiUnavailable: 'Melis AI is not available on this page.',
    ecMoveBlockUp: 'Move block up',
    ecMoveBlockDown: 'Move block down',
    ecMiniTemplate: 'Mini-template',
    ecPluginPrefix: 'Plugin',
    ecClose: 'Close',
    ecAllGroups: 'All groups',
    ecZoneWord: 'zone',
    ecSearchPlugin: 'Search a plugin…',
    ecLoadingPlugins: 'Loading plugins…',
    ecNoPluginMatch: 'No plugin matches.',
    ecSelectPage: 'Select a page',
    ecRemovePluginTitle: 'Remove this plugin?',
    ecRemovePluginBody1: 'will be removed from the zone. You can add it back, but its configuration will be lost.',
    ecRemoveBtn: 'Remove',
    ecRemoveZoneTitle: 'Remove this zone?',
    ecRemoveZoneBody1: 'and everything in it will be removed from the page. This cannot be undone.',
    ecPluginNotFound: 'Plugin not found in the document — configuration not possible.',
    ecConfigFor: 'Config',

    // ── PluginFormKit ──
    pfFixFields: 'Please fix the fields',
    pfSaveFailed: 'Save failed.',
    pfNetworkError: 'Network error',
    pfChoose: '— Choose —',
    pfChooseTemplate: '— Choose a template —',
    pfTemplateHint: 'Rendering template of the plugin.',
    pfFormFields: 'Form fields',
    pfColField: 'Field',
    pfColShow: 'Show',
    pfColRequired: 'Required',
    pfNoField: 'No field.',
    pfDragToReorder: 'Drag to reorder',
    pfShowField: 'Show this field',
    pfMakeRequired: 'Make required',
  },
}
