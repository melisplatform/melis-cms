import { Fragment, useEffect, useLayoutEffect, useRef, useState, type CSSProperties, type ChangeEvent, type ReactNode, type RefObject } from 'react'
...
function Kpi({ label: l, value, icon, tint }: { label: string; value: number | null; icon?: ReactNode; tint?: string }) {
