            ...
            if (file_exists($path)) {
                ...
                foreach ($mini_templates_temp as $mini_template) {
                    ...
                    if (! empty($thumbnail)) {
                        ...
                        $thumbnail = '<img class="mini-template-tool-table-image" src="' . '/' . $post['site_name'] . '/miniTemplatesTinyMce/' . $thumbnail['file'] . '?rand=' . uniqid('', true) . '" width="195" height="100%">';
                    } else {
                        $thumbnail = '<img class="mini-template-tool-table-image" src="/MelisFront/plugins/images/default.jpg" width="195" height="100%">';
                    }
