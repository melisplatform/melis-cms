    ...
    public function attach(EventManagerInterface $events)
    {
        ...
        $callBackHandler = $sharedEvents->attach(
        	...
        	function($e){
                ...
                $tableSite404 = $sm->get('MelisEngineTableSite404');
                $tableSite404->save(array(
                    's404_id' => 1,
                    's404_site_id' => -1,
                    's404_page_id' => 1
                ));
                ...
                // CMS Lang
                $tableCmsLang = $sm->get('MelisEngineTableCmsLang');
                $tableCmsLang->save(array(
                    'lang_cms_id' => 1,
                    'lang_cms_locale' => 'en_EN',
                    'lang_cms_name' => 'English'
                ));
                $tableCmsLang->save(array(
                    'lang_cms_id' => 2,
                    'lang_cms_locale' => 'fr_FR',
                    'lang_cms_name' => 'Français'
                ));
