<?php
return array(
    'tr_meliscms_ws_desc_site' => 'CMS sites: list of a site\'s pages.',
	'tr_meliscms_menu_sitetree_Name' => 'Site tree view',
	'tr_meliscms_sites_tools' => 'Site Tools',
	...
	'tr_meliscms_menu_dupe_page_relation_fail' => 'Already has a version in this language',
	'tr_meliscms_menu_dupe_page_relation_conflict' => 'Cannot duplicate with the "Relationship with an initial page" option: one or more pages already have a version in %s. Uncheck this option, or choose another language.',
	'tr_meliscms_menu_dupe_page_relation_initial_conflict' => 'Cannot duplicate: one or more sub-pages are already linked to the source page. Uncheck "Relationship with an initial page".',
	'tr_meliscms_menu_dupe_destination_fail' => 'The destination page does not exist',
	'tr_meliscms_menu_dupe_source_fail' => 'The source page does not exist',
