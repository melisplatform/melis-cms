<?php 
	return array(  
		...
		'tr_meliscms_page_Page last published on' => 'publiée le',
		'tr_meliscms_page_By' => 'par',
	    ...
	    'tr_meliscms_page_actions_new' => 'Nouvelle page',
	    'tr_meliscms_page_actions_delete' => 'Supprimer',
	    'tr_meliscms_page_actions_delete_tooltip' => 'Ne peut pas être supprimée, la page a des pages enfants',
	    
	    'tr_meliscms_page_published_text' => 'En ligne',
	    'tr_meliscms_page_unpublished_text' => 'Hors ligne',
	    'tr_meliscms_page_status_text' => 'Statut',

	    'tr_meliscms_page_actions_New' => 'Nouvelle page',
	    'tr_meliscms_page_actions_Delete Page' => 'Supprimer page',
		'tr_meliscms_page_actions_Unpublish' => 'Dépublier',
		'tr_meliscms_page_actions_Publish Unpublish' => 'Publier / Dépublier',
		'tr_meliscms_page_actions_Delete' => 'Supprimer',
	    'tr_meliscms_page_actions_Create' => 'Créer',
		'tr_meliscms_page_actions_Notes' => 'Notes',
		'tr_meliscms_page_actions_Preview' => 'Aperçu',
	    'tr_meliscms_page_actions_See' => 'Voir',
		'tr_meliscms_page_actions_See Online' => 'Voir en ligne',
		'tr_meliscms_page_actions_display_Display' => 'Affichage',
	    ...
	    'tr_meliscms_delete_saved_use_tpl_default_confirmation_msg' => 'Etes-vous sûr de vouloir effacer la version sauvegardée et revenir à la version du template?',
	    'tr_meliscms_delete_saved_success_title' => 'Effacer la sauvegarde',
	    'tr_meliscms_delete_saved_success' => 'La sauvegarde a été supprimée avec succès',
	    'tr_meliscms_delete_no_saved_page' => 'Cette page n\'a pas d\'édition en cours',
			
		'tr_meliscms_page_tab_edition_Edition' => 'Edition',
		'tr_meliscms_page_tab_properties_Properties' => 'Propriétés',	
		'tr_meliscms_page_tab_seo_Seo' => 'SEO',		

	    'tr_meliscms_page_tab_edition_Edition_Page not editable' => 'Cette page n\'est pas éditable',
		...
		'tr_meliscms_page_success_Page published' => 'Page publiée',
		...
		'tr_meliscms_page_save_error_Current page id has reached end of platform band' => 'L\'identifiant de page a atteint la fin de la bande plateforme définie',
		'tr_meliscms_page_save_error_Current page id defined in platform is already used' => 'L\'identifiant de page défini dans platform est déjà utilisé',
		'tr_meliscms_page_error_Your rights don\'t allow you to see this page' => 'Vos droits ne vous autorisent pas à voir cette page',
		'tr_meliscms_page_error_Your rights don\'t allow you to modify this page' => 'Vos droits ne vous autorisent pas à modifier cette page',
		'tr_meliscms_page_error_You cannot delete a page having children pages' => 'Vous ne pouvez pas supprimer une page ayant des pages enfants',
		'tr_meliscms_page_error_Children pages' => 'Pages enfants',
		'tr_meliscms_page_error_No id found' => 'Aucun identifiant trouvé',
		'tr_meliscms_page_error_No id' => 'Pas d\'id',
		'tr_meliscms_page_error_Page doesn\'t exist' => 'La page n\'existe pas',
		'tr_meliscms_page_error_Some errors occured while processing the request.' => 'Des erreurs sont apparues lors du traitement de la demande.',
	    'tr_meliscms_page_error_Some errors occured while processing the request. Please find details bellow.' => 'Des erreurs sont apparues lors du traitement de la demande.',
		'tr_meliscms_page_error_lebel_Rights' => 'Droits',
		'tr_meliscms_page_save_error_SEO Url already used on' => 'Url SEO déjà utilisée sur',
		'tr_meliscms_page_save_error_label_SEO Url' => 'SEO Url',
        'tr_meliscms_page_save_error_platform_id_max' => 'Id page',
        'tr_meliscms_page_save_error_platform_id_used' => 'Page id used',
				
		'tr_meliscms_page_error_Page is not published yet' => 'La page n\'est pas encore publiée',
        ...
        'tr_meliscms_tool_site_col_site_name' => 'Nom',
        'tr_meliscms_tool_site_col_site_scheme' => 'Scheme',
        'tr_meliscms_tool_site_col_site_domain' => 'Domaine',
        'tr_meliscms_tool_site_col_site_env' => 'Environnement',
        
        'tr_meliscms_tool_site_add' => 'Ajouter un nouveau site',
        'tr_meliscms_tool_site_delete_success' => 'Le site à été supprimé avec succès',
        'tr_meliscms_tool_site_delete_failed' => 'Impossible de supprimer le site, veuillez réessayer',
	    
	    'tr_meliscms_tool_site_delete_env_success' => 'L\'environnement du site a été supprimé',
	    'tr_meliscms_tool_site_delete_env_failed' => 'Impossible de supprimer l\'environnement du site, merci de rééssayer plus tard',
        
        'tr_meliscms_tool_site_add_success' => 'Le site a été ajouté avec succès',
        'tr_meliscms_tool_site_add_failed' => 'Impossible d\'ajouter le site, veuillez réessayer',
	    ...
	    'tr_tool_no_access' => 'Vous n\'avez pas les droits pour accéder à cet outil',
	    ...
	    'tr_meliscms_page_creation' => 'Nouvelle page',
	    
	    // tree button if pages is empty
	    'tr_meliscms_create_page' => 'Nouvelle page',
...
// 	    'tr_meliscms_tool_language_lang_locale tooltip' => 'tr_meliscms_tool_language_lang_locale tooltip text',
	    ...
	    'tr_meliscms_tool_language_edit' => 'Editer le Langage',
	    'tr_meliscms_tool_language_add_success' => 'Nouveau langage ajouté avec succès',
	    'tr_meliscms_tool_language_add_failed' => 'Impossible d\'ajouter un langage, veuillez réessayer',
	    'tr_meliscms_tool_language_add_exists' => 'La locale existe déjà',
	    'tr_meliscms_tool_language_edit_success' => 'Langage mis à jour avec succès',
	    'tr_meliscms_tool_language_edit_failed' => 'Impossible de mettre à jour le langage, veuillez réessayer',
	    'tr_meliscms_tool_language_delete_confirm' => 'Êtes-vous sûr de vouloir supprimer ce langage ?',
	    ...
	    'tr_meliscms_dashboard_pages_indicators_description' => 'Ce plugin affiche le nombre de sites, de pages créées ainsi que le nombre de pages publiées et non publiées.',
	    ...
	    'tr_meliscms_dashboard_pages_indicators_unpublished' => 'Dépubliée',
	    
	    //DataTables Translations
	    'tr_meliscms_dt_sEmptyTable' => 'Aucune donn&eacute;e disponible dans le tableau',
	    'tr_meliscms_dt_sInfo' => 'Affichage de l\'&eacute;lement _START_ &agrave; _END_ sur _TOTAL_ &eacute;l&eacute;ments',
	    'tr_meliscms_dt_sInfoEmpty' => 'Affichage de l\'&eacute;lement 0 &agrave; 0 sur 0 &eacute;l&eacute;ments',
	    ...
	    'tr_meliscms_dt_sNext' => 'Suivant',
	    'tr_meliscms_dt_sPrevious' => 'Pr&eacute;c&eacute;dent',
	    'tr_meliscms_dt_sSortAscending' => 'activer pour trier la colonne par ordre croissant',
	    'tr_meliscms_dt_sSortDescending' => ' activer pour trier la colonne par ordre d&eacute;croissant',
        ...
        'tr_melis_cms_sites_tool_add_step3_domain_unique_error' => 'Les noms de domaine doivent être uniques',
        ...
        'tr_melis_cms_sites_tool_add_create_site_success' => 'Site créé avec succès',
        'tr_melis_cms_sites_tool_add_create_site_already_exist' => 'Impossible de créer le site, le nom du site est déjà utilisé',
        ...
        'tr_melis_cms_sites_module_loading_activate_module_with_prerequisites_notice' => '<i class="fa fa-warning"></i>   <strong>[%s]</strong> requiert des modules supplémentaires pour fonctionner : ',
        ...
        'tr_meliscms_tool_site_module_load_no_rights' => 'Les droits sur votre système de fichiers (<p class="module-rights-err"><b>%s</b></p>) ne vous autorisent pas à modifier les fichiers.',
        ...
        'tr_melis_site_translation_text_col' => 'Texte',
        'tr_melis_site_translation_key_col' => 'Clef',
        ...
        'tr_melis_cms_sites_tool_languages_option2' => 'Je veux afficher la locale après mon domaine (ex: www.monsite.com/en/monurl) <span class="melis-radio-box-circle"></span>',
        'tr_melis_cms_sites_tool_languages_option1' => 'Je ne veux rien, l\'url de la page sera établie uniquement sur le nom de la page <span class="melis-radio-box-circle"></span>',
        ...
        'tr_melis_cms_sites_tool_content' => 'Contenu de site',
        'tr_melis_cms_sites_tool_content_header' => 'En-tête contenu de site',
        'tr_melis_cms_sites_tool_content_edit_header' => 'En-tête éditer site',
        'tr_melis_cms_sites_tool_content_edit_button_save' => 'Bouton sauvegarder éditer site',
